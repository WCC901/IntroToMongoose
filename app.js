...
const Tweet = require = require(`./tweet.js`);
...
// const myFirstTweet = {
//     title: "Deep Thoughts",
//     body: "Hot Take: (Insert very lukewarm take)",
//     author: "Some Random",
// };
...
//     console.log(err);
// })
// // close db connection after either way
// .finally(() => {
//     db.close();
// });
...
// Find tweets by id
// Tweet.findById("65bbef284228398a63f61a1f", "title body")
